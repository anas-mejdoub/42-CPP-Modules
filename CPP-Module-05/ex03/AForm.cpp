...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/06 11:34:39 by amejdoub          #+#    #+#             */
/*   Updated: 2025/01/06 11:36:37 by amejdoub         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Form::setSigned_contract(bool a)
{
    _signed_contract = a;
}

bool Form::getSigned_contract() const
{
    return _signed_contract;
}